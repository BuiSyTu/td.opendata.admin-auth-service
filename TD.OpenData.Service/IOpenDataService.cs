...
namespace TD.OpenData.Service
{
    ...
    public partial interface IOpenDataService
    {
        ...
        [OperationContract]
        [WebGet(UriTemplate = "UserTokenKey?user={user}&pass={pass}", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        Stream GetUserTokenKey(string user = null, string pass = null);
